...
class AlexNet(object):
    ...
    def createModel(features, labels, mode):
        ...
        lrn1 = tf.nn.local_response_normalization(input=pool1, depth_radius=2, alpha=1e-05, beta=0.75)
        ...
        lrn2 = tf.nn.local_response_normalization(input=pool2, depth_radius=2, alpha=1e-05, beta=0.75)
        ...
        # Fully connected layers
        fc1 = tf.layers.dense(inputs=flatten, units=4096, activation=tf.nn.relu)
