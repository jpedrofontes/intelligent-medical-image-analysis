  ...
  \chapter{Development} \label{development}
    ...
    \section{Implementation} \label{development:implementation}
      ...
      \subsection{Preprocessing}
        ...
        \begin{figure}[t!]
          \centering
          \includegraphics[width=\textwidth]{./img/pp-benign.png}
          \caption[Preprocessing stages]{Preprocessing stages. In the first image we can see the raw image with the lesion segmented. The second image is the result of the extraction of the \gls{roi} where the tumor is. The third image is the result of the computation of the intensity gradient. Finally, the fourth image represents the final image, after the histogram equalization process.}
